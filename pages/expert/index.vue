  ...
  <div class="bg-white min-h-screen font-sans">
    ...
    <div class="px-4 pb-4 flex space-x-2 overflow-x-auto">
      <button
        ...
        :class="['px-4 py-1 rounded-full text-sm', selectedCategory === '' ? 'bg-red-100 text-red-500' : 'bg-gray-100 text-gray-500']"
      >
        全部
      </button>
      <button
        ...
        :class="['px-4 py-1 rounded-full text-sm whitespace-nowrap', selectedCategory === category ? 'bg-red-100 text-red-500' : 'bg-gray-100 text-gray-500']"
      >
        {{ category }}
      </button>
    </div>
    ...
    <main>
      <div class="px-4 pb-20">
          ...
          <div class="flex items-center mb-4">
            ...
            <div class="flex-grow">
              <div class="flex justify-between items-center">
                <div>
                  <p class="font-bold">{{ expert.expertUserCn }} <span class="text-gray-500 font-normal">{{ expert.expertUserId }}</span></p>
                ...
                <button class="bg-red-500 text-white w-8 h-8 rounded-full flex items-center justify-center">
        ...
        <div v-if="experts.length === 0" class="text-center text-gray-500 mt-8">
          No experts found.
        </div>
      </div>
    </main>
...
const API_URL = '/expertsTable/findList';
...
const categories = ['普惠链接', '普惠教育', '普惠政务', '普惠能源', '普惠安全'];
